...
|                  |                                                                                                                                           |
| ---------------- | ----------------------------------------------------------------------------------------------------------------------------------------- |
| **Source**       | https://prod1gitlab.mapcom.local/dsc/configurations/CerificateServicesTasks/-/tree/master/CertificaeServicesTasks/DscResources/PfxImports |
...
### Table. Attributes of `PfxImports`
...
PfxImports:
  Items:
    ...
    - Thumbprint: c81b94933420221a7ac004a90242d8b1d3e5070d
      ...
      FriendlyName: My Company Certificate
      ...
      # Account used to run this resource of the target node
