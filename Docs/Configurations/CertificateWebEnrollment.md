...
|                  |                                                                                                                          |
| ---------------- | ------------------------------------------------------------------------------------------------------------------------ |
| **Source**       | https://prod1gitlab.mapcom.local/dsc/configurations/CerificateServicesTasks/-/tree/master/CertificaeServicesTasks/DscResources/CertificateWebEnrollment |
...
### Table. Attributes of `CertificateWebEnrollment`
...
## Example `CertificateWebEnrollment`
...
CertificateWebEnrollment:
  ...
  CAConfig: DC1-ADCS-SRV01\MAPCOM-Issuing-CA
